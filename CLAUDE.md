...
- Pinned upstream commit: **`v0.5.3`** tag (commits up through `ea0d4ee8c`).
- Latest pin-drift review: [`docs/upstream-sync-2026-07-25.md`](docs/upstream-sync-2026-07-25.md)
