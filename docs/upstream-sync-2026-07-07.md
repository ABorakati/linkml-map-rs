...
| `9674b92d65` | 2026-06-25 | Restore back-compat: coerce a bare-string `source_schema`/`target_schema` to the structured `SchemaReference` object form | **Already ported** — `deserialize_schema_reference_option` in `crates/linkml-map-core/src/datamodel/mod.rs` (L68-73, citing v0.6.0 #215). Was incorrectly marked "Deferred" in the 2026-07-07 review; corrected 2026-07-25. |
